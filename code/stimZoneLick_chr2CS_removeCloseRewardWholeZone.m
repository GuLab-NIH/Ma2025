...
%this removal will not work for reward CS stimulation because in that case,
%all stimulation zones were removed because they were all close to reward
...
save('chr2CSLickUseWholeZone.mat','allLickAfterAllUse','allLickBeforeAllUse','allLickStimAllUse','allLickAfterAllPerSession','allLickBeforeAllPerSession','allLickStimAllPerSession')
