function [decePercentileBefore,decePercentileStim,decePercentileAfter] = decelerationPercCueStim(speedBefore,speedStim,speedAfter,yBefore,yStim,yAfter,stimLoc,stimExp1,stimExp2,samplingSpacing)
