%did not remove the zone in this code: but this one did: stimZoneLick_chr2CS_removeCloseRewardWholeZone
...
allLickPositionStim={}; %each cell is a session, within: per run: within: position of each lick. Starting from zero position, which is the stimulation starts
allLickPositionBefore={}; %each cell is a session, within: per run: within: position of each lick. Starting from zero position, which is the stimulation starts-15cm
allLickPositionAfter={}; %each cell is a session, within: per run: within: position of each lick. Starting from zero position, which is the stimulation end
