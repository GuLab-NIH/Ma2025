...
allIdxAll{2}=setdiff([1:1:length(idxCHR2CS)],[1 2 3 6 7 10 11 12 13 15 14]); %chr2 CS: remove 12 and 14: too many lick signals per bin
allIdxAll{3}=setdiff([1:1:length(idxGFPRS)],[8 10]);%GFPRS
allIdxAll{4}=setdiff([1:1:length(idxGFPCS)],[9 10]); %GFP CS
...
saveas(gcf,'absPreRewardictiveLickingGOOD.fig')
...
ylim([0 9])
saveas(gcf,'RBRTogetherAbsBeforeRewardGOOD.fig')
...
ylim([0 17])
saveas(gcf,'RBRTogetherAbsBeforeRewardNormGOOD.fig')
...
saveas(gcf,'lickDistributionALLGOOD.fig')
...
saveas(gcf,'lickDistributionALL_noNormalizeGOOD.fig')
...
saveas(gcf,'lickDistributionALL_noNormalizeChangeGOOD.fig')
...
saveas(gcf,'lickDistributionALL_noNormalizeChangeAvgSessionGOOD.fig')
...
saveas(gcf,'lickDistributionALL_NormalizeChangeAvgSessionGOOD.fig')
...
tightfig
saveas(gcf,'lickDistriRBRCHR2CSGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
saveas(gcf,'lickDistriRBRCHR2RSGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
tightfig
saveas(gcf,'lickDistriRBRGFPCSGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
saveas(gcf,'lickDistriRBRGFPRSGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
tightfig
saveas(gcf,'lickDistriRBRCHR2CSBeforeGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
saveas(gcf,'lickDistriRBRCHR2RSBeforeGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
tightfig
saveas(gcf,'lickDistriRBRGFPCSBeforeGood.fig')
...
title(['late runs',num2str(dayThresh+1),'to',num2str(size(countRBR,1))])
saveas(gcf,'lickDistriRBRGFPRSBeforeGood.fig')
