...
tightfig;
saveas(gcf,'aligniningStimZoneLowerLickFarApart50cmExp_combineStimDelay5PostEarly.fig')
print -painters -depsc aligniningStimZoneLowerLickFarApart50cmExp_combineStimDelay5PostEarly.eps
...
dur=meanSpeedAll{N};
tightfig;
saveas(gcf,'aligniningStimZoneLowerLickFarApart50cmExp_combineStimDelay5DurLast.fig')
print -painters -depsc aligniningStimZoneLowerLickFarApart50cmExp_combineStimDelay5DurLast.eps
...
tightfig;
saveas(gcf,'aligniningStimZoneLowerLickFarApart50cmExp_combineStimDelay5PreEarly.fig')
print -painters -depsc aligniningStimZoneLowerLickFarApart50cmExp_combineStimDelay5PreEarly.eps
...
allBefore=[beforebeforeSpeed beforedurSpeed beforeafterSpeed];
 ...
 [pAnova,pMC,pLabel] = anovaRM2W_full_BH(beforebeforeSpeed,precedingbeforeSpeed,1);
 [pAnova2,pMC,pLabel] = anovaRM2W_full_BH(beforedurSpeed,precedingdurSpeed,1);
 [pAnova3,pMC,pLabel] = anovaRM2W_full_BH(beforeafterSpeed,precedingafterSpeed,1);
...
title([num2str([pAnova(1) pAnova2(1) pAnova3(1)])])
...
saveas(gcf,'predictSlowMemory.fig')
print -painters -depsc predictSlowMemory.eps
