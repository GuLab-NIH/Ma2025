function [lickPercentileBefore,lickPercentileStim,lickPercentileAfter] = lickPercCueStimRS(lickUsePositionBeforeRBR,lickUsePositionStimRBR,lickUsePositionAfterRBR,stimLocAll,stimExp1,stimExp2,samplingSpacing)
